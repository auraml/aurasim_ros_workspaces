...
def declare_actions(
    ...
    # DISABLED: twist_mux already publishes to cmd_vel_unstamped directly
    ...
    # Bridge unstamped cmd_vel into the controller reference topic
    # FIXED: Removed is_public_sim check - relay needed for all sim modes
    cmd_vel_reference_relay = ExecuteProcess(
        cmd=[
            ...
            PathJoinSubstitution([
                LaunchConfiguration('namespace'), 'mobile_base_controller', 'reference_unstamped'
            ])
        ],
        name='cmd_vel_reference_relay',
        respawn=True,
        condition=IfCondition(
            PythonExpression(
                [
    ...
    launch_description.add_action(cmd_vel_reference_relay)
